...
export const Terminal = (props: LucideProps) => <LucideTerminal size={15} strokeWidth={2} {...props} />
...
export const Archive = (props: LucideProps) => <LucideArchive size={14} strokeWidth={2} {...props} />
